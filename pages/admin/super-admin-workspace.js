...
const links=[['Dashboard','/admin/'],['Users','/admin/users/'],['Subscriptions','/admin/subscriptions/'],['Usage','/admin/usage/'],['Interventions','/admin/interventions/'],['Settings','/admin/settings/'],['Reports','/admin/reports/'],['System','/admin/system/'],['Security','/admin/security/'],['Resume Services','/admin/resume-services/'],['CV Specialists','/admin/cv-specialists/']];
